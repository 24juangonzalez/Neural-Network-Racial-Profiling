...
df = pd.read_csv(r'C:/Users/Juan Gonzalez/OneDrive/Documents\Machine Learning/2019_Racial_Profiling__RP__Arrests.csv')

dataset = df[['APD_RACE_DESC','RACE_KNOWN','Reason for Stop – TCOLE form', 'Person Search YN','Search Based On','Search Found']]
